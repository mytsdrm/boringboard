...
type BoardMember struct {
	...
	// Restricts editor/commenter access to selected Status options.
	// required: false
	StatusScopeEnabled bool `json:"statusScopeEnabled"`

	// Status option ids this member can work with. "__no_status__" means empty Status.
	// required: false
	StatusScopeOptionIDs []string `json:"statusScopeOptionIds"`
}
